<template>
  <div class="app-container">
    <el-form ref="form" :model="form" label-width="110px">
      <el-form-item label="详细地址：" prop="address" class="mt-5">
        <el-autocomplete
      ...
      <el-form-item class="d-flex jc-end pr-6 mt-5">
...
export default {
 ...
 props: {
    msg: String,
    cityhandle:Function  //这是一个属性，他接受father传过来的方法
  },
  data() {
    return {
      form: {
  ...
  async mounted() {
    await loadBMap('uccI1y7M4mA6dAPRuGs2HAPd0RCQNo5W') // 加载引入BMap
    this.initMap()
  },
  methods: {
    // 初始化地图
    ...
    getAddrByPoint(point) {
      ...
      geco.getLocation(point, function(res) {
        ...
        that.form.addressComponents = res.addressComponents
    ...
    onSubmit() {
        if(this.form.addressComponents.city===undefined){
            alert("请点击地图完成定位")
        }
      console.log(this.form.addressComponents.city)
      this.$emit('cityhandle',this.form.addressComponents.city,this.form.address)
